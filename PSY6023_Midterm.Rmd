...
```
 ...
 Question 1: Use computer sofware to caculate Cronbach's alpha for each of the five scales. 
...
Question 2: Calculate the variance-covariance matricies for each of the five scales. Then calculate the Cronbach's Alpha using the classical definition of the alpha (by hand or with hand calculator). 
...
Question 3: Are the alpha values identical between #1 and #2?
...
Question 4: Calculate split-half reliability analyses for each of the five scales. Appy the Spearman-Brown prophecy formula to estimate internal consistency of the scale. Did the split-half reliability estimate yield the same value as alpha? Why?
...
Question 5: Using the single factor model, conduct the tests of homogeneity for each scale. Interpret the results. Test whether the items are essentially tau-equivalent for each of the five scales. Also, test whether the items are parallel for each of the five scales. 
...
Question 6: Calculate McDonald's omega for each of the five scales. Also calculate 95% CI for the omega estimates.
